...
$instance = $DB->get_record('enrol', array('id' => $enrolid, 'enrol' => 'badgeenrol'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/badgeenrol/unenrolself.php', array('enrolid' => $instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_badgeenrol', format_string($course->fullname));
